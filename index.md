...
across decades of longitudinal follow-up, serving as the definitive reference for all data held within the cohort.
...
into categories and subcategories, making it straightforward to locate data from specific 
sweeps or topic areas across the cohort's history.
